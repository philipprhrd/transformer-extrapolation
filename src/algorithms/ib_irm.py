...
class IBIRMAlgorithm(BaseAlgorithm):
    """
    ...
    def compute_loss(
        ...
        **kwargs
        ...
        Args:
            ...
            features: Feature representations from the model (required for IB_IRM)
            
        Returns:
            IB_IRM loss (base loss + IRM penalty + IB penalty)
        """
        if features is None:
            raise ValueError("Features are required for IB_IRM algorithm")
